...
# test_images_path = '/home/vishy/Desktop/Kaggle/Avito/Data/test_jpg/'
# train_images_path = '/home/vishy/Desktop/Kaggle/Avito/Data/sample_images/'
...
print("Dullness and Whiteness complete")
"""
def average_pixel_width(img):
    path = test_images_path + img
    im = IMG.open(path)
...
print("Average pixel width complete")
...
print("Dominanat colour complete")
...
print("Average colour complete")

def get_blurrness_score(image):
    path =  test_images_path + image
...
print("Blurness complete")

def getSize(filename):
    filename = test_images_path + filename
    st = os.stat(filename)
    return st.st_size
...
"""
print(features.shape)
features.to_csv("train_img_features_1.csv",index=False)
#features.to_csv("test_img_features_1.csv",index=False)
